...
namespace SGAmod.NPCs
{
	...
	public class SandscorchedGolem : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
			...
			return !spawnInfo.playerInTown && !NPC.BusyWithAnyInvasionOfSorts() && !Main.pumpkinMoon && !Main.snowMoon && !Main.eclipse && spawnInfo.spawnTileY < Main.rockLayer && spawnInfo.player.ZoneDesert && Main.hardMode ? 0.15f : 0f;
		}
