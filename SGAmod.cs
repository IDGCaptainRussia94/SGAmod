...
namespace SGAmod
{
	...
	class SGAmod : Mod
	{
		...
		public override void AddRecipes()
		{
			...
			if (bossList != null)
			{
				...
				bossList.Call("AddBossWithInfo", "Copper Wraith", 0.05f, (Func<bool>)(() => (SGAWorld.downedWraiths > 0)), string.Format("Use a [i:{0}], defeat this boss to unlock crafting the furnace", ItemType("WraithCoreFragment")));
				...
				bossList.Call("AddBossWithInfo", "Cobalt Wraith", 6.6f, (Func<bool>)(() => (SGAWorld.downedWraiths>1)), string.Format("Use a [i:{0}], defeat this boss to unlock crafting a hardmode anvil", ItemType("WraithCoreFragment2")));
	...
	public override void AddRecipeGroups()
    {
		...
		public override void HandlePacket(BinaryReader reader, int whoAmI)
		{
			...
			if (type==MessageType.CratrosityNetSpawn && Main.netMode==2){
