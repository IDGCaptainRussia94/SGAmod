                ...
                if (WorldGen.genRand.Next(0, 100) < 2)
                {
                    ...
                    if (tile1.active() && tile2.active() && !tile3.active() && !tile4.active())
                    {
                        ...
                        if (thechest > 0)
                        {
                            ...
                            List<int> lootmain = new List<int> { SGAmod.Instance.ItemType("UnmanedOre"), SGAmod.Instance.ItemType("DankWood"), SGAmod.Instance.ItemType("DankWood"), SGAmod.Instance.ItemType("Biomass"), SGAmod.Instance.ItemType("DankWood"), ItemID.SilverCoin, ItemID.LesserManaPotion };
