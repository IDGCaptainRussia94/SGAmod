...
namespace SGAmod.Items.Weapons
{
	public class CreepersThrow : ModItem
    {
        public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("Controls a yoyo shaped creeper that lites a fuse when near enemies and explodes violently shortly after\nHowever, watch out as you can hurt yourself from the creeper's explosion");
		}
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            tooltips.Add(new TooltipLine(mod, "IDG Debug Item", Idglib.ColorText(c, "Mister Creeper's other dev weapon")));
        }
