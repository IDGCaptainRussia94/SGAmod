...
namespace SGAmod.Items.Weapons
{
	public class AvaliScythe : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("Spins a duo-scythe around the player that speeds up the longer you hold the button" +
				"\nafter holding for a short while, release to throw the weapon, up to double the damage and increased speed depending on charge and dealing throwing damage instead" + "\n'The weapon of the fallen dragon'");
